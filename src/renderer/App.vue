<template>
  ...
  >
    ...
    <BatchAnalysisDialog v-if="store.appState === AppState.BATCH_ANALYSIS_DIALOG" />
...
import BatchAnalysisDialog from "@/renderer/view/dialog/BatchAnalysisDialog.vue";
...
import BookmarkTourDialog from "./view/dialog/BookmarkTourDialog.vue";
